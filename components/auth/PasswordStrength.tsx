...
import { validatePasswordPolicy, getPasswordStrengthColor, getPasswordStrengthPercentage } from '@/lib/firebase/password-policy';
      ...
      <div className="w-full bg-gray-200 rounded-full h-2">
        <div
          className={`h-2 rounded-full transition-all duration-300 ${
            strength.strength === 'very-strong' ? 'bg-green-600' :
