        ...
        <div className="flex items-center space-x-4 sm:space-x-6">
          ...
          <div className="hidden lg:flex items-center space-x-4"> 
            <Link
              href="/auth/login"
              className="
                px-5 sm:px-6 py-2 rounded-full text-white text-sm font-semibold
                bg-gray-600 shadow-[0_0_15px_rgba(0,0,0,0.4)]
                hover:shadow-white bg-white/10
          ...
          <HiBars3BottomRight
            onClick={openNav}
            className="
              lg:hidden w-7 h-7 sm:w-8 sm:h-8 text-white cursor-pointer 
