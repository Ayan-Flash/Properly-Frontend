...
export default function LoginPage() {
	...
	const handleLogin = async (event: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			...
			const code = loginError?.code ? String(loginError.code) : 'auth/unknown-error'
	...
	const fillDemoCredentials = () => {
		setEmail('demo@properly.com')
		setPassword('properly@123')
	}
						...
						<div className="flex items-start">
							<div className="flex-1">
								...
								<p className="text-xs text-blue-700 mt-1">
									Email: <strong>demo@properly.com</strong> | Password: <strong>properly@123</strong>
								</p>
							</div>
							<button
								type="button"
